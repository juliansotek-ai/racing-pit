...
export function TrainersTable({
  ...
  const sorted = useMemo(() => {
    return [...trainers].sort((a, b) => {
      ...
      else if (sortKey === "totalHorses") { va = a.totalHorses; vb = b.totalHorses; }
      else if (sortKey === "totalRunners") { va = a.totalRunners; vb = b.totalRunners; }
      ...
      <table className="w-full text-sm border-collapse">
        <thead>
          <tr>
            ...
            <SortTh active={sortKey === "totalHorses"} sortDir={sortDir} colKey="totalHorses" onSort={handleSort} className="hidden sm:table-cell">
              Horses
            </SortTh>
            <SortTh active={sortKey === "totalRunners"} sortDir={sortDir} colKey="totalRunners" onSort={handleSort}>
              Runners
            </SortTh>
            ...
            >
              ...
              {showBetStats && (
                <td className="py-3 pl-3 text-right tabular-nums font-medium hidden sm:table-cell">
                  <RoiCell roi={trainer.roi} betsPlaced={trainer.betsPlaced} />
                </td>
              )}
            </tr>
          ))}
